"""
Target quantum parameters for the 5-qubit linear chain chip.

Frequencies are staggered to avoid frequency collisions and
to enable frequency-selective control.
"""
...
PARAM_TARGETS = {
    ...
    # ── Coupler frequencies (linear chain: 4 couplers) ───────────────────
    param(n.COUPLER_12, n.FREQ): 8.5e9,
    param(n.COUPLER_23, n.FREQ): 8.7e9,
    param(n.COUPLER_34, n.FREQ): 8.9e9,
    param(n.COUPLER_45, n.FREQ): 9.1e9,
    ...
    # ── Resonator-feedline capacitance (tee coupling, fF) ────────────────
